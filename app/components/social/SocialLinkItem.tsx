...
export default function SocialLinkItem({ link, variant = "desktop" }: SocialLinkItemProps) {
  ...
  return (
    <div className={`flex justify-between items-center ${isMobile ? "p-3" : "p-2"} bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border border-gray-200 hover:shadow-md hover:border-gray-300 transition-all duration-300 cursor-pointer group`}>
