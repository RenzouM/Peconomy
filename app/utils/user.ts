// Frontend-compatible signer interface
...
export const AUDITOR_SECRET_KEY = 12847321338015819245445518144028570538408927360876901642159872299055545378037n;
...
export class User {
  ...
  genRegistrationHash(chainId: bigint) {
    const registrationHash = poseidon3([chainId, this.formattedPrivateKey, BigInt(this.signer.address)]);
